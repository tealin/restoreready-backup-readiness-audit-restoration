...
<div align="center">
  <img src="./public/logo.svg" alt="RestoreReady — PC backups — Restoration" width="64" height="64">
  <h1>RestoreReady — PC backups — Restoration</h1>
</div>

An independent project specification for PC backups, covering backup coverage matrix, restore drill checklist, destination capacity estimate.
...
<img src="./public/screenshots/desktop-main.svg" alt="PC backups — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="PC backups — compact concept, not a screenshot" width="250">
<br>
...
- **Backup coverage matrix** — planned module; not implemented.
- **Restore drill checklist** — planned module; not implemented.
- **Destination capacity estimate** — planned module; not implemented.

The proposed workflow separates backup coverage matrix from restore drill checklist, with destination capacity estimate retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Backup coverage matrix**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="RestoreReady — PC backups — Restoration — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the PC backups version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Restore drill checklist

Define the input and expected outcome for module 2. Record the PC backups version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Destination capacity estimate

Define the input and expected outcome for module 3. Record the PC backups version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Backup coverage matrix |
