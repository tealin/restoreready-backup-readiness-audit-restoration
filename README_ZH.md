...
- **备份覆盖矩阵** (Backup coverage matrix) — 规划模块，尚未实现。
- **恢复演练清单** (Restore drill checklist) — 规划模块，尚未实现。
- **目标位置容量估算** (Destination capacity estimate) — 规划模块，尚未实现。
